...
- `REQUIRED_DATA_FORMAT.md` (historical file, unavailable) — column-level contract
- `REQUIRED_DATA_FORMAT.md` (historical file, unavailable) — same contract in deploy package
